"""
Copy CRISPR_HNN datasets to CRISPR-UniPredict project
"""
...
source_dir = Path(r"c:\Users\shahe\Desktop\both paper models\crisprhnn")
dest_dir = Path(r"c:\Users\shahe\Desktop\both paper models\CRISPR-UniPredict\data\raw\crispr_hnn")

# Ensure destination exists
dest_dir.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("COPYING CRISPR_HNN DATASETS")
print("=" * 80)
print(f"\nSource: {source_dir}")
